...
#	pip install -e .[dev]
	...
	flake8 alchemyjsonschema --count --select=E9,F63,F7,F82 --show-source --statistics
	# exit-zero treats all errors as warnings. The GitHub editor is 127 chars wide
	flake8 alchemyjsonschema --count --ignore W503,E203,E501 --exit-zero --max-complexity=10 --max-line-length=127 --statistics
